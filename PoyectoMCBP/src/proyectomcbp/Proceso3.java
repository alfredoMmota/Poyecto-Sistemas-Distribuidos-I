...
public class Proceso3 extends javax.swing.JFrame {
    ...
    public void MostrarVT() {
        vector = mcbp.ObtenerVectorProceso(2);
        String vectorVT = "(";
    ...
    public void VerificarMensaje(String a) {
        ...
        String estado = mcbp.RecepcionMensajes(2, Integer.parseInt(Datos[0]), Integer.parseInt(Datos[1]), Datos[3]);
        if ("Entrega".equals(estado)) {
            int posicion = Integer.parseInt(Datos[0]);
            mcbp.ModificarVT(2, posicion - 1);
            if (ci.isEmpty()) {
    ...
    private void P1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P1ActionPerformed
        ...
        try {
            byte[] m;
            InetAddress aHost = InetAddress.getByName(P3.getServer());
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P3.getDirecciones(0));
            P3.Socket.send(enviado);
    ...
    private void P2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P2ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P3.getDirecciones(1));
            P3.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso3.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void P4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P4ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P3.getDirecciones(3));
            P3.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso3.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void P5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P5ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P3.getDirecciones(4));
            P3.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso3.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void P6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P6ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P3.getDirecciones(5));
            P3.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso3.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void CrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CrearActionPerformed
        mensaje = "3-" + contador + "-" + Mensaje.getText() + "-";
        if (ci.isEmpty()) {
            mensaje = mensaje + "0";
        } else {
            for (int i = 0; i < ci.size(); i++) {
