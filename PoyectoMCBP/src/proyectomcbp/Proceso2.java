...
public class Proceso2 extends javax.swing.JFrame {
    ...
    public Proceso2() {
        initComponents();
        P2.run(6791);// se declara el numero puerto para el proceso 2
        MostrarVT();
    ...
    public void MostrarVT() {
        vector = mcbp.ObtenerVectorProceso(1);
        String vectorVT = "(";
    ...
    public void VerificarMensaje(String a) {
        ...
        String estado = mcbp.RecepcionMensajes(1, Integer.parseInt(Datos[0]), Integer.parseInt(Datos[1]), hm);
        if ("Entrega".equals(estado)) {
            int posicion = Integer.parseInt(Datos[0]);
            mcbp.ModificarVT(1, posicion - 1);
            if (ci.isEmpty()) {
    ...
    private void P1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P1ActionPerformed
        ...
        try {
            byte[] m;
            InetAddress aHost = InetAddress.getByName(P2.getServer());
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P2.getDirecciones(0));
            P2.Socket.send(enviado);
    ...
    private void P3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P3ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P2.getDirecciones(2));
            P2.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso2.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void P4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P4ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P2.getDirecciones(3));
            P2.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso2.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void P5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P5ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P2.getDirecciones(4));
            P2.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso2.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void P6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P6ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P2.getDirecciones(5));
            P2.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso2.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void CrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CrearActionPerformed
        mensaje = "2-" + contador + "-" + Mensaje.getText() + "-";
        if (ci.isEmpty()) {
            mensaje = mensaje + "0";
        } else {
            for (int i = 0; i < ci.size(); i++) {
