 ...
 * @author Alfredo Mota
 */
public class Proceso6 extends javax.swing.JFrame {

    conexion P6 = new conexion();
    ...
    public void MostrarVT() {
        vector = mcbp.ObtenerVectorProceso(5);
        String vectorVT = "(";
    ...
    public void recibir() {
        try {
            ...
            Logger.getLogger(Proceso6.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void VerificarMensaje(String a) {
        ...
        String estado = mcbp.RecepcionMensajes(5, Integer.parseInt(Datos[0]), Integer.parseInt(Datos[1]), Datos[3]);
        if ("Entrega".equals(estado)) {
            int posicion = Integer.parseInt(Datos[0]);
            mcbp.ModificarVT(5, posicion - 1);
            if (ci.isEmpty()) {
    ...
    private void P1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P1ActionPerformed
        ...
        try {
            byte[] m;
            InetAddress aHost = InetAddress.getByName(P6.getServer());
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P6.getDirecciones(0));
            P6.Socket.send(enviado);
    ...
    private void P2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P2ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P6.getDirecciones(1));
            P6.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso6.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void P3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P3ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P6.getDirecciones(2));
            P6.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso6.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void P4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P4ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P6.getDirecciones(3));
            P6.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso6.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void P5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P5ActionPerformed
        ...
        try {
            ...
            String m1 = Historial.getSelectedValue();
            m = m1.getBytes();
            DatagramPacket enviado = new DatagramPacket(m, m.length, aHost, P6.getDirecciones(4));
            P6.Socket.send(enviado);
            Reporte.setText("Mensaje Enviado");
        } catch (UnknownHostException ex) {
            Logger.getLogger(Proceso6.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void CrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CrearActionPerformed
        mensaje = "6-" + contador + "-" + Mensaje.getText() + "-";
        if (ci.isEmpty()) {
            mensaje = mensaje + "0";
        } else {
            for (int i = 0; i < ci.size(); i++) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Proceso6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
